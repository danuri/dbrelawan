    ...
    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          ...
          <div class="page-title-right">
              <ol class="breadcrumb m-0">
                  <li><a href="<?= site_url('relawan/kecamatan/'.$idkel)?>" class="btn btn-sm btn-danger"><i class="ri-arrow-left-line"></i> Kembali</a></li>
              </ol>
          </div>
      </div>
  </div>
              ...
              <form class="" action="<?= site_url('relawan/add')?>" method="post" id="addform">
                ...
                <div class="row mb-3">
                  ...
                  <select class="form-select" name="jenis_kelamin" id="jenis_kelamin">
                    ...
                    <input type="hidden" name="jenis" value="korrt">
